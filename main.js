...
class UI {
  ...
  displayContent() {
    main.addEventListener("click", (event) => {
      ...
      if (
        event.target.getAttribute("data-name") === "btn" &&
  ...
  highlightSelected(e) {
    ...
    dropdownSection === "content-location"
      ? this.unHighlightSelected(contentLocation)
      : "";
    dropdownSection === "content-type"
      ? this.unHighlightSelected(contentType)
      : "";
    dropdownSection === "content-bedrooms"
      ? this.unHighlightSelected(contentBedrooms)
      : "";
    dropdownSection === "content-bathrooms"
      ? this.unHighlightSelected(contentBathrooms)
      : "";
    dropdownSection === "content-toilets"
      ? this.unHighlightSelected(contentToilets)
      : "";
        ...
        if (nullInputs.length !== 0) {
          nullInputs.forEach((val) => {
            ...
            val === "house-type"
              ...
              : "";
            val === "Bedrooms"
              ? (Object.assign(dropBtn[2].style, css),
                Object.assign(dropBtn[7].style, css))
              : "";
            val === "Bathrooms"
              ? (Object.assign(dropBtn[3].style, css),
                Object.assign(dropBtn[8].style, css))
              : "";
            val === "Toilets"
              ? (Object.assign(dropBtn[4].style, css),
                Object.assign(dropBtn[9].style, css))
              : "";
          });
          error.forEach(
            (err) => (err.innerText = "Please select input for all fields!")
          );
          return;
        }
